...
namespace WindowsFormsApp3
{
    public partial class Dashboard3 : Form
    {
        ...
        {
            OpenChildForm(new Forms.FormMemberReport(), sender);
        }

        private void button1_Click(object sender, EventArgs e)
        {
            OpenChildForm(new Forms.FormTrainerReport(), sender);
        }

        private void button2_Click(object sender, EventArgs e)
        {
            OpenChildForm(new Forms.FormAddTrainer(), sender);
        }

        private void button3_Click(object sender, EventArgs e)
        {
            OpenChildForm(new Forms.FormManageAccounts(), sender);
        }
        ...
        {
            OpenChildForm(new Forms.FormAddGym(), sender);
        }
