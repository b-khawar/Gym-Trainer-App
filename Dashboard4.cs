...
namespace WindowsFormsApp3
{
    public partial class Dashboard4 : Form
    {
        ...
        {
            OpenChildForm(new Forms.Performance_of_Gyms(), sender);
        }

        private void button1_Click(object sender, EventArgs e)
        {
            OpenChildForm(new Forms.Gym_Registration_Requests(), sender);
        }

        private void button2_Click(object sender, EventArgs e)
        {
            OpenChildForm(new Forms.Revoke_Memberships(), sender);
        }
        ...
        //{
        //    OpenChildForm(new Forms.FormBookTrainingSession(), sender);
        //}

        //private void button5_Click(object sender, EventArgs e)
        //{
        //    OpenChildForm(new Forms.FormTrainerFeedback(), sender);
        //}
